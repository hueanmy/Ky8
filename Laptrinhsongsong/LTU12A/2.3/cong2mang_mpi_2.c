...
int main(int argc,char **argv){
	...
	// }
	MPI_Scatter(A,Mc, MPI_INT,Ac,Mc, MPI_INT, 0,MPI_COMM_WORLD);//tuong duong 26-37
	MPI_Scatter(B,Mc, MPI_INT,Bc,Mc, MPI_INT, 0,MPI_COMM_WORLD);
	// Tinh toan
  ...
  //   }
	MPI_Gather(Cc,Mc,MPI_INT,C,Mc,MPI_INT,0,MPI_COMM_WORLD); //tuong duong 43-49
	// Print result
